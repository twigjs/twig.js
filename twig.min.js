...
return a}(Twig||{});
Twig=function(a){a.exports={};a.exports.twig=function(b){var c=b.id;if(b.debug!==void 0)a.debug=b.debug;if(b.data!==void 0)return new a.Template({data:b.data,id:c});else if(b.ref!==void 0){if(b.id!==void 0)throw Error("Both ref and id cannot be set on a twig.js template.");return a.Templates.load(b.ref)}else if(b.href!==void 0)return a.Templates.loadRemote(b.href,{id:c,precompiled:b.precompiled},b.async,b.load)};a.exports.extendFilter=function(b,c){a.filter.extend(b,c)};a.exports.extendTest=function(b,
c){a.test.extend(b,c)};a.exports.extendTag=function(b){a.logic.extend(b)};a.exports.compile=function(b,c){var d=new a.Template({data:b,id:c.filename});return function(a){return d.render(a)}};return a}(Twig||{});typeof module!=="undefined"&&module.declare?module.declare(function(){}):typeof module!=="undefined"&&module.exports?module.exports=Twig.exports:(window.twig=Twig.exports.twig,window.Twig=Twig);
