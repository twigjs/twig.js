...
a.prepare=function(c){a.log.debug("Twig.prepare: ","Tokenizing ",c);c=a.tokenize.apply(this,[c]);a.log.debug("Twig.prepare: ","Compiling ",c);c=a.compile.apply(this,[c]);a.log.debug("Twig.prepare: ","Compiled ",c);return c};a.Templates={registry:{}};a.Templates.save=function(c){if(c.id===void 0)throw new a.Error("Unable to save template with no id");a.Templates.registry[c.id]=c};a.Templates.load=function(c){return!a.Templates.registry.hasOwnProperty(c)?null:a.Templates.registry[c]};a.Templates.loadRemote=
function(c,b,f,g){var h=b.id,i=b.blocks,j=b.precompiled,l=null;h===void 0&&(h=c);if(a.Templates.registry.hasOwnProperty(h))return a.Templates.registry.hasOwnProperty(h);if(typeof XMLHttpRequest=="undefined")throw Error("Unsupported platform: Unable to do remote requests because there is no XMLHTTPRequest implementation");var k=new XMLHttpRequest;k.onreadystatechange=function(){var b=null;if(k.readyState==4)a.log.debug("Got template ",k.responseText),j===true?(b=JSON.parse(k.responseText),l=new a.Template({data:b,
blocks:i,id:h})):(l=new a.Template({data:k.responseText,blocks:i,id:h}),l.url=c),g&&g(l)};k.open("GET",c,f===true);k.send();if(f===false)return l};a.Template=function(d){var e=d.data,f=d.id,d=d.blocks,g;this.id=f;this.blocks=d||{};this.extend=null;this.tokens=b("String",e)?a.prepare.apply(this,[e]):e;this.render=function(b,d){var e=this,f,k=d&&d.output=="blocks";this.importBlocks=function(d,f){var g=c(e.url,d),i=a.Templates.loadRemote(g,{id:g},false),f=f||false;i.render(b);Object.keys(i.blocks).forEach(function(a){if(f||
e.blocks[a]===void 0)e.blocks[a]=i.blocks[a]})};f=a.parse.apply(this,[this.tokens,b]);return this.extend?(g=c(this.url,this.extend),this.parent=a.Templates.loadRemote(g,{id:g,blocks:this.blocks},false),this.parent.blocks=this.blocks,this.parent.render(b)):k===true?this.blocks:f};f!==void 0&&a.Templates.save(this)};return a}(Twig||{});
