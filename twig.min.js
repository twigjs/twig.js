var twig=function(a){var b=a.id;if(a.debug!==void 0)Twig.debug=a.debug;if(a.data!==void 0)return new Twig.Template(a.data,b);else if(a.ref!==void 0){if(a.id!==void 0)throw Error("Both ref and id cannot be set on a twig.js template.");return Twig.Templates.load(a.ref)}else if(a.href!==void 0)return Twig.Templates.loadRemote(a.href,b,a.load,a.async,a.precompiled)};twig.compile=function(a,b){var d=b.filename,c=Twig.prepare(a),e=Twig.Templates.load(d)||new Twig.Template(c,d);return function(a){return e.render(a)}};
var Twig=function(a){function b(a,b){var e=Object.prototype.toString.call(b).slice(8,-1);return b!==void 0&&b!==null&&e===a}a.trace=false;a.debug=false;a.Error=function(a){this.message=a;this.name="Twig.Exception"};a.Error.prototype.toString=function(){return this.name+": "+this.message};a.log={trace:function(){a.trace&&console.log(Array.prototype.slice.call(arguments))},debug:function(){a.debug&&console.log(Array.prototype.slice.call(arguments))}};a.token={};a.token.type={output:"output",logic:"logic",
comment:"comment",raw:"raw"};a.token.definitions={output:{type:a.token.type.output,open:"{{",close:"}}"},logic:{type:a.token.type.logic,open:"{%",close:"%}"},comment:{type:a.token.type.comment,open:"{#",close:"#}"}};a.token.strings=['"',"'"];a.token.findStart=function(b){var c={position:null,def:null},e,f,g;for(e in a.token.definitions)if(a.token.definitions.hasOwnProperty(e)&&(f=a.token.definitions[e],g=b.indexOf(f.open),a.log.trace("Twig.token.findStart: ","Searching for ",f.open," found at ",g),
g>=0&&(c.position===null||g<c.position)))c.position=g,c.def=f;return c};a.token.findEnd=function(b,c,e){for(var f=null,g=false,h=0,i=null,k=null,j=null,l=i=null,i=null,m,n;!g;){k=i=null;j=b.indexOf(c.close,h);if(j>=0)f=j,g=true;else throw new a.Error("Unable to find closing bracket '"+c.close+"' opened near template position "+e);n=a.token.strings.length;for(m=0;m<n;m+=1)if(l=b.indexOf(a.token.strings[m],h),l>0&&l<j&&(i===null||l<i))i=l,k=a.token.strings[m];if(i!==null){i+=1;f=null;for(g=false;;){i=
b.indexOf(k,i);if(i<0)throw"Unclosed string in template";if(b.substr(i-1,1)!=="\\"){h=i+1;break}else i+=1}}}return f};a.tokenize=function(b){for(var c=[],e=0,f=null,g=null;b.length>0;)f=a.token.findStart(b),a.log.trace("Twig.tokenize: ","Found token: ",f),f.position!==null?(f.position>0&&c.push({type:a.token.type.raw,value:b.substring(0,f.position)}),b=b.substr(f.position+f.def.open.length),e+=f.position+f.def.open.length,g=a.token.findEnd(b,f.def,e),a.log.trace("Twig.tokenize: ","Token ends at ",
g),c.push({type:f.def.type,value:b.substring(0,g).trim()}),b=b.substr(g+f.def.close.length),e+=g+f.def.close.length):(c.push({type:a.token.type.raw,value:b}),b="");return c};a.compile=function(b){for(var c=[],e=[],f=[],g=null,h=g=g=null,i=null,k=h=null,j=null,l=null;b.length>0;){g=b.shift();switch(g.type){case a.token.type.raw:e.length>0?f.push(g):c.push(g);break;case a.token.type.logic:g=a.logic.compile.apply(this,[g]);k=g.type;j=a.logic.handler[k].open;l=a.logic.handler[k].next;a.log.trace("Twig.compile: ",
"Compiled logic token to ",g," next is: ",l," open is : ",j);if(j!==void 0&&!j){h=e.pop();i=a.logic.handler[h.type];if(i.next.indexOf(k)<0)throw Error(k+" not expected after a "+h.type);h.output=h.output||[];h.output=h.output.concat(f);f=[];h={type:a.token.type.logic,token:h};e.length>0?f.push(h):c.push(h)}if(l!==void 0&&l.length>0){a.log.trace("Twig.compile: ","Pushing ",g," to logic stack.");if(e.length>0)h=e.pop(),h.output=h.output||[],h.output=h.output.concat(f),e.push(h);e.push(g)}else j!==void 0&&
j&&(h={type:a.token.type.logic,token:g},e.length>0?f.push(h):c.push(h));break;case a.token.type.output:a.expression.compile.apply(this,[g]),e.length>0?f.push(g):c.push(g)}a.log.trace("Twig.compile: "," Output: ",c," Logic Stack: ",e," Pending Output: ",f)}if(e.length>0)throw g=e.pop(),Error("Unable to find an end tag for "+g.type+", expecting one of "+g.next.join(", "));return c};a.parse=function(b,c){var e=[],f=true,c=c||{};b.forEach(function(b){a.log.debug("Twig.parse: ","Parsing token: ",b);switch(b.type){case a.token.type.raw:e.push(b.value);
break;case a.token.type.logic:b=a.logic.parse.apply(this,[b.token,c,f]);if(b.chain!==void 0)f=b.chain;if(b.context!==void 0)c=b.context;b.output!==void 0&&e.push(b.output);break;case a.token.type.output:e.push(a.expression.parse.apply(this,[b.stack,c]))}});return e.join("")};a.prepare=function(b){a.log.debug("Twig.prepare: ","Tokenizing ",b);b=a.tokenize(b);a.log.debug("Twig.prepare: ","Compiling ",b);b=a.compile(b);a.log.debug("Twig.prepare: ","Compiled ",b);return b};a.Templates={registry:{}};a.Templates.save=
...
Twig=function(a){a.logic={};a.logic.type={if_:"if",endif:"endif",for_:"for",endfor:"endfor",else_:"else",elseif:"elseif",set:"set"};a.logic.definitions=[{type:a.logic.type.if_,regex:/^if\s+([^\s].+)$/,next:[a.logic.type.else_,a.logic.type.elseif,a.logic.type.endif],open:true,compile:function(b){b.stack=a.expression.compile.apply(this,[{type:a.expression.type.expression,value:b.match[1]}]).stack;delete b.match;return b},parse:function(b,d,c){var e="",f=a.expression.parse.apply(this,[b.stack,d]),c=
true;f===true&&(c=false,e=a.parse.apply(this,[b.output,d]));return{chain:c,output:e}}},{type:a.logic.type.elseif,regex:/^elseif\s+([^\s].*)$/,next:[a.logic.type.else_,a.logic.type.endif],open:false,compile:function(b){b.stack=a.expression.compile.apply(this,[{type:a.expression.type.expression,value:b.match[1]}]).stack;delete b.match;return b},parse:function(b,d,c){var e="";c&&a.expression.parse.apply(this,[b.stack,d])===true&&(c=false,e=a.parse.apply(this,[b.output,d]));return{chain:c,output:e}}},
{type:a.logic.type.else_,regex:/^else$/,next:[a.logic.type.endif,a.logic.type.endfor],open:false,parse:function(b,d,c){var e="";c&&(e=a.parse.apply(this,[b.output,d]));return{chain:c,output:e}}},{type:a.logic.type.endif,regex:/^endif$/,next:[],open:false},{type:a.logic.type.for_,regex:/^for\s+([a-zA-Z0-9_,\s]+)\s+in\s+([^\s].+)$/,next:[a.logic.type.else_,a.logic.type.endfor],open:true,compile:function(b){var d=b.match[1],c=b.match[2],e=null,e=null;b.key_var=null;b.value_var=null;if(d.indexOf(",")>=
0)if(e=d.split(","),e.length===2)b.key_var=e[0].trim(),b.value_var=e[1].trim();else throw new a.Error("Invalid expression in for loop: "+d);else b.value_var=d;e=a.expression.compile.apply(this,[{type:a.expression.type.expression,value:c}]).stack;b.expression=e;delete b.match;return b},parse:function(b,d,c){var e=a.expression.parse.apply(this,[b.expression,d]),f=[],g;e instanceof Array?(g=0,e.forEach(function(c){d[b.value_var]=c;b.key_var&&(d[b.key_var]=g);f.push(a.parse.apply(this,[b.output,d]));
g+=1})):e instanceof Object&&(c=e._keys!==void 0?e._keys:Object.keys(e),c.forEach(function(c){c!=="_keys"&&e.hasOwnProperty(c)&&(d[b.value_var]=e[c],b.key_var&&(d[b.key_var]=c),f.push(a.parse.apply(this,[b.output,d])))}));c=f.length===0;return{chain:c,output:f.join("")}}},{type:a.logic.type.endfor,regex:/^endfor$/,next:[],open:false},{type:a.logic.type.set,regex:/^set\s+([a-zA-Z0-9_,\s]+)\s*=\s*(.+)$/,next:[],open:true,compile:function(b){var d=b.match[1].trim(),c=a.expression.compile.apply(this,
[{type:a.expression.type.expression,value:b.match[2]}]).stack;b.key=d;b.expression=c;delete b.match;return b},parse:function(b,d,c){var e=a.expression.parse.apply(this,[b.expression,d]);d[b.key]=e;return{chain:c,context:d}}}];a.logic.handler={};a.logic.extendType=function(b,d){a.logic.type[b]=d||"Twig.logic.type"+b};for(a.logic.extend=function(b){if(!b.type)throw new a.Error("Unable to extend logic definition. No type provided for "+b);a.logic.handler[b.type]=b};a.logic.definitions.length>0;)a.logic.extend(a.logic.definitions.shift());
a.logic.compile=function(b){var b=b.value.trim(),b=a.logic.tokenize(b),d=a.logic.handler[b.type];d.compile&&(b=d.compile(b),a.log.trace("Twig.logic.compile: ","Compiled logic token to ",b));return b};a.logic.tokenize=function(b){var d={},c=null,e=null,f=null,g=null,f=f=null,b=b.trim();for(c in a.logic.handler)if(a.logic.handler.hasOwnProperty(c)){e=a.logic.handler[c].type;f=a.logic.handler[c].regex;g=[];for(f instanceof Array?g=f:g.push(f);g.length>0;)if(f=g.shift(),f=f.exec(b.trim()),f!==null)return d.type=
e,d.match=f,a.log.trace("Twig.logic.tokenize: ","Matched a ",e," regular expression of ",f),d}throw new a.Error("Unable to parse '"+b.trim()+"'");};a.logic.parse=function(b,d,c){var e="",f,d=d||{};a.log.debug("Twig.logic.parse: ","Parsing logic token ",b);f=a.logic.handler[b.type];f.parse&&(e=f.parse(b,d,c));return e};return a}(Twig||{});
