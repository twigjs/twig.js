module.declare(
    ...
    , function (require, exports, module) {
        ...
        (function () {
            ...
            const g = h.jQuery || h.Zepto; e.noConflict = function () {
                h.Backbone = p; return this;
            };

            e.emulateHTTP = !1; e.emulateJSON = !1; e.Events = {bind(a, b, c) {
                const d = this._callbacks || (this._callbacks = {}); (d[a] || (d[a] = [])).push([b, c]); return this;
            }, unbind(a, b) {
                let c; if (a) {
...
0, e = c.length; d < e; d++) {
                ...
                let b; let c; let d; let e; let f = 2; if (!(c = this._callbacks)) {
                    return this;
                }
                ...
                let c; a || (a = {}); if (c = this.defaults) {
                    f.isFunction(c) && (c = c.call(this)), a = f.extend({}, c, a);
                }

                this.attributes = {};
                this._escapedAttributes = {}; this.cid = f.uniqueId('c'); this.set(a, {silent: !0}); this._changed = !1; this._previousAttributes = f.clone(this.attributes); if (b && b.collection) {
            ...
            f.extend(e.Model.prototype, e.Events, {_previousAttributes: null, _changed: !1, idAttribute: 'id', initialize() {}, toJSON() {
                return f.clone(this.attributes);
            }, get(a) {
                return this.attributes[a];
            }, escape(a) {
                let b; if (b = this._escapedAttributes[a]) {
                    return b;
                }

                b = this.attributes[a];
                return this._escapedAttributes[a] = (b == null ? '' : String(b)).replace(/&(?!\w+;|#\d+;|#x[\da-f]+;)/gi, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g, '&#x2F;');
            }, has(a) {
